...
/**
 * This is the item provider adapter for a {@link org.nasdanika.bank.CustomerAccount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomerAccountItemProvider extends AccountItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CustomerAccount_product_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CustomerAccount_product_feature", "_UI_CustomerAccount_type"),
				 BankPackage.Literals.CUSTOMER_ACCOUNT__PRODUCT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOwnersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CustomerAccount_owners_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CustomerAccount_owners_feature", "_UI_CustomerAccount_type"),
				 BankPackage.Literals.CUSTOMER_ACCOUNT__OWNERS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BankPackage.Literals.CUSTOMER_ACCOUNT__DEVICES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BankPackage.Literals.CUSTOMER_ACCOUNT__DEVICES,
				 BankFactory.eINSTANCE.createCard()));
	}
