...
public class TokenItemProvider 
	...
	/**
	 * This adds a property descriptor for the Merchant feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMerchantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Token_merchant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Token_merchant_feature", "_UI_Token_type"),
				 BankPackage.Literals.TOKEN__MERCHANT,
				 true,
				 false,
				 true,
				 null,
