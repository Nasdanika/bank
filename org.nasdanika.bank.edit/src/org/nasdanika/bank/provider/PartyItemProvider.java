...
/**
 * This is the item provider adapter for a {@link org.nasdanika.bank.Party} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BankPackage.Literals.PARTY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BankPackage.Literals.PARTY__CONTACT_METHODS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BankPackage.Literals.PARTY__CONTACT_METHODS,
				 BankFactory.eINSTANCE.createEMail()));

		newChildDescriptors.add
			(createChildParameter
				(BankPackage.Literals.PARTY__CONTACT_METHODS,
				 BankFactory.eINSTANCE.createPhone()));
		...
		newChildDescriptors.add
			(createChildParameter
				(BankPackage.Literals.PARTY__CONTACT_METHODS,
				 BankFactory.eINSTANCE.createWebAddress()));
	}
