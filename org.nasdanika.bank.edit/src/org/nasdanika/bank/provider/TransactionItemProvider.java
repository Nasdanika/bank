...
/**
 * This is the item provider adapter for a {@link org.nasdanika.bank.Transaction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransactionItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDebitPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Debit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDebitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transaction_debit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transaction_debit_feature", "_UI_Transaction_type"),
				 BankPackage.Literals.TRANSACTION__DEBIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCreditPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transaction_credit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transaction_credit_feature", "_UI_Transaction_type"),
				 BankPackage.Literals.TRANSACTION__CREDIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInitiatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transaction_initiator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transaction_initiator_feature", "_UI_Transaction_type"),
				 BankPackage.Literals.TRANSACTION__INITIATOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transaction_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transaction_amount_feature", "_UI_Transaction_type"),
				 BankPackage.Literals.TRANSACTION__AMOUNT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BankPackage.Literals.TRANSACTION__DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transaction_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transaction_comment_feature", "_UI_Transaction_type"),
				 BankPackage.Literals.TRANSACTION__COMMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BankPackage.Literals.TRANSACTION__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
